...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="{{asset('public/http://html5shim.googlecode.com/svn/trunk/html5.js')}}"></script>
    <![endif]-->
</head>
...
<nav class="navbar navbar-default bootsnav no-background navbar-fixed black">
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><img src="{{asset('public/images/logo.png')}}" class="logo" alt=""></a>
        </div>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="banner">
                    ...
                    <div class="inner_banner">
                        ...
                        <div class="stamp">
                            <img src="{{asset('public/images/stamp.png')}}" alt="" />
                        </div>
                    </div>
                </div>
            </div>
...
<section id="block">
    <div class="container">
            ...
            <div class="col-sm-8">
                <div class="feature">
                    <div class="shack_burger">
                        <div class="chicken">
                            <img src="{{asset('public/images/chicken.png')}}" alt="Chicken" />
                        </div>
                ...
                <div id="small_carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="{{asset('public/images/small_slider_bg.jpg')}}" alt="" />
                        </div>
                        <div class="item">
                            <img src="{{asset('public/images/small_slider_bg.jpg')}}" alt="" />
                        </div>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="{{asset('public/images/large_slider_img.jpg')}}" alt="Burger">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-4 col-xs-12 pull-right">
                <div class="basic_info">
                    <a href=""><img class="footer_logo" src="{{asset('public/images/footer_logo.png')}}" alt="Burger" /></a>
...
<div class="scrollup">
    <a href="#"><i class="fa fa-chevron-up"></i></a>
        ...
        <!-- JavaScript -->
<script src="{{asset('public/http://code.jquery.com/jquery-1.12.1.min.js')}}"></script>
<script src="{{asset('public/images/footer_logo.pnghttps://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js')}}"></script>
<!-- Bootsnav js -->
