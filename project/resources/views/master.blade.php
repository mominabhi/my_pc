...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/front_end_asset/tabcontent.css')}}" />
    <script type="text/javascript" src="{{asset('public/front_end_asset/tabcontent.js')}}">
        /***********************************************
